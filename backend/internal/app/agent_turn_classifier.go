...
func (a *App) agentTurnClassifierPrompt(ctx context.Context, tenantID, sessionID string, req aiChatRequest) string {
	...
	b.WriteString("Plan_request dipakai kalau user meminta aksi besar berbasis kisi-kisi yang layak dipecah jadi batch, misalnya audit kisi-kisi, perbaiki slot tidak lengkap, selesaikan kekurangan materi/TP/indikator, atau eksekusi bertahap. Jangan pakai plan_request untuk aksi kecil 1-5 slot yang cukup langsung proposal_request. ")
