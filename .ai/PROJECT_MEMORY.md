...
- Kisi-kisi execution planner is now a supported backend capability: plan-first actions with batch execution, progress summary, retry handling, and explicit audit semua kisi-kisi trigger
