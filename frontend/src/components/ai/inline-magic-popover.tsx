...
const QUESTION_QUALITY_CONTRACT = `Kualitas soal wajib tinggi. Sebelum membuat soal, buat kisi-kisi INTERNAL dulu untuk mengontrol kualitas (topik, jenjang/asumsi, kompetensi, indikator konseptual, cognitiveLevel, difficulty), tetapi JANGAN tampilkan kisi-kisi internal kecuali user meminta. Jika exam memakai kisi-kisi dan soal baru belum punya blueprintSlotId, setelah soal dibuat lanjutkan dengan apply_question_kisi_kisi/bulk_apply_question_kisi_kisi untuk menyimpan kisi-kisi yang sesuai dan link ke soal. Jika data user kurang lengkap, gunakan asumsi wajar dan tuliskan asumsi singkat di awal. Setiap soal minimal memiliki stimulus/konteks; stimulus boleh berdiri sendiri atau langsung tertanam di stem soal, tetapi jangan membuat stem terlalu pendek tanpa konteks kecuali user meminta. Default tipe soal adalah multiple_choice; jangan membuat short_answer kecuali user eksplisit meminta. Setiap soal harus: sesuai topik dan jenjang; level kognitif jelas; tidak ambigu; tidak sekadar hafalan jika diminta level tinggi; opsi jawaban homogen, setara panjang/jenisnya, dan plausible; hanya satu jawaban benar; menyertakan kunci dan pembahasan singkat. Indikator internal harus konseptual, tidak menyalin redaksi soal, tidak membocorkan jawaban.`;
